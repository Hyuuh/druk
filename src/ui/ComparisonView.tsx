...
function Message(props: { title: string; detail?: string }) {
  return (
    <box flexGrow={1} flexDirection="column" backgroundColor={ui.bg} padding={2}>
      <text fg={ui.text} bg={ui.bg} content={props.title} />
      <Show when={props.detail}>
        {(detail: Accessor<string>) => <text fg={ui.dim} bg={ui.bg} content={detail()} />}
      </Show>
      <text fg={ui.faint} bg={ui.bg} content="Esc closes this page." />
    </box>
  )
}
